    ...
    <div class="row mt-2 w-full" style="height: 450px;">
      ...
      <template #arrow-right>
       <q-btn
        ...
        <vueper-slide @click="modal('https://image.tmdb.org/t/p/w500' + i.poster_path, i.title, 'populares', i.overview, i.id)" class="p-0 column" v-for="i in moviesPopulars" :key="i.id">
          <template #content>             
